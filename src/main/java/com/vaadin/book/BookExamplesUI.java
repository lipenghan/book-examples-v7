...
@JavaScript({ "js/jquery-2.1.0.min.js",
		"js/custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js" })
...
public class BookExamplesUI extends UI {
	...
	protected void init(VaadinRequest request) {
		...
		Label broken = new Label(
				"Notice - some examples are broken at the moment");
	...
	// BookExamplesUI.class, widgetset =
	// "com.vaadin.book.widget.BookExamplesWidgetSet")
