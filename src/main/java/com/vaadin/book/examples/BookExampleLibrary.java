...
public class BookExampleLibrary {
    ...
    final AbstractExampleItem examples[] = {
            ...
            new BookExample("application.lifecycle.closing", "Closing a Session", LifecycleExample.class),
            ...
            new ExampleCtgr("advanced.fonticon-", "Font Icons"),
            new BookExample("advanced.fonticon.basic", "Basic Use", FontIconExample.class),
            new BookExample("advanced.fonticon.html", "Using in HTML", FontIconExample.class),
            new BookExample("advanced.fonticon.all", "All FontIcons", FontIconExample.class),
            new BookExample("advanced.fonticon.intext", "FontIcon in any text", FontIconExample.class),
            new BookExample("advanced.fonticon.custom", "Custom FontIcons", FontIconExample.class),
